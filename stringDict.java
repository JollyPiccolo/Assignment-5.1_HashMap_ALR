...
public class stringDict {
	...
	/**
	 * add method - Char based
	 * adds an item and it's key to the dictionary, through converting the inputs into strings
	 * @param String key, String data
	 */
	
	public void add(char[] key, char[] data) {
		String newkey = new String(key);
		String newdata = new String(data);
		dictionary.put(newkey, newdata);
	}
	...
	public void printAll(String key) {
		...
		System.out.println("Word: " + this.getKey(data) + "; Definition: \"" + dictionary.get(key) + "\" ; HashCode: " + hash);
